...
def main():
    ...
    st.markdown(
        ...
        "Of that total, **${gift:.2f}** ({percentage:.0f}%) was charged to gift cards.".format(
            total=range_total, gift=range_gift_total, percentage=(range_gift_total / range_total) * 100))
    ...
    st.markdown(
        ...
        "Of that total, **${gift:.0f}** ({percentage:.0f}%) was charged to gift cards.".format(
            total=total, gift=gift_total, percentage=(gift_total / total) * 100))
